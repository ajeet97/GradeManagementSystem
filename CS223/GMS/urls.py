...
urlpatterns = [
	...
	url(r'^students/(?P<student_id>\w+)/view/$', views.viewStudent, name = 'viewStudent'),
	...
	url(r'^instructors/(?P<instructor_id>\w+)/view/$', views.viewInstructor, name = 'viewInstructor'),
